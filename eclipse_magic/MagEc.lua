-- Eclipse Magic
-- Programmed exposure sequence for a solar eclipse (35mm Huluchuan)
...
if ( TestTime == 0 )
then
	-- La Silla (UTC-4): 15:23:26.1 16:39:24.3 16:41:15.6 17:47:16.7
	c1.hr = 12; c1.min = 23; c1.sec = 26;
	c2.hr = 13; c2.min = 40; c2.sec = 54;
	c3.hr = 13; c3.min = 44; c3.sec = 36;
	c4.hr = 15; c4.min = 02; c4.sec = 46;
else
	-- Testing:
	c1.hr = 0; c1.min =  0; c1.sec = 10;
	c2.hr = 0; c2.min =  1; c2.sec = 10;
	c3.hr = 0; c3.min =  2; c3.sec = 1;
	c4.hr = 0; c4.min =  3; c4.sec = 1;
end
...
function main()
	...
	then
		...
		then
			...
			camera.aperture.value = Aperture1
		...
		then
			...
			camera.aperture.value = Aperture2
